...
As questões que possuim mais subsmissões são: 
...
Após descobrir as 5 questões que possuem o maior número de submissões, foi calculado a média do número de submissões da amostra para essas 5 questões. Com 95% de precissão temos o seguinte resultado.
