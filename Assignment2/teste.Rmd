...
É possível notas que a maioria dos valores não ficaram tão próximos da média da população. Por esse motivo irei repetir o experimento e dessa vez aumentar o número de amostras mantendo o número de observações de dentro das amostras contante (tamanho 100).
...
É possível notar que quanto maior for o número das amostras mais próximo a distribuição se parece com a distribuição normal (confirmando assim o teorema do limite central). Sendo o valor com maior número de ocorrência o valor bastante próximo do valor da média da população. Para uma melhor visualização da evolução observe os três gráficos abaixo. 
